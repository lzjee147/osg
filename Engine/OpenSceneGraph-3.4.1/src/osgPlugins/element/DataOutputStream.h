...
public:
	...
	void writeCollapseResult(const osg::EdgeCollapse::CollapseResult& collresult);
	void writePointSet(const osg::EdgeCollapse::PointSet& pointset);
	void writePointSets(const osg::EdgeCollapse::PointSet& pointset);   //≤‚ ‘“ª¥Œ–¥≥ˆ
	void writePoint(const osg::ref_ptr<osg::EdgeCollapse::Point>& point);

	void writeTriangleSet(const osg::EdgeCollapse::TriangleSet& triangletset);
	void writeTriangle(const osg::ref_ptr<osg::EdgeCollapse::Triangle>& triangle);

	void writeCollInfoList(const osg::EdgeCollapse::EdgeCollapseInfoList& cloresult);

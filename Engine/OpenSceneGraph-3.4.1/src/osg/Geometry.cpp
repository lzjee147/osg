...
void Geometry::draw_xxx(RenderInfo& renderInfo)
{
...
void Geometry::compileGLObjects(RenderInfo& renderInfo) const
{
    ...
    if (useVertexArrays)
    {
		...
		//É¾µôÄÚ´æ
		//_vertexArray->setThreadSafeRefUnref(true);
		//_normalArray->setThreadSafeRefUnref(true);
		//_colorArray->setThreadSafeRefUnref(true);

		//_texCoordList[0]->setThreadSafeRefUnref(true);
    }
    else
    {
